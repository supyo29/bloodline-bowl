...
test("PRODUCTION ISOLATION: only the Book-Ready adapter layer, the persistence capture path and the cron route import lib/matchup2; production matchup/lineup/Start-Sit/waivers/trades never do; the substrate is read-only", () => {
  ...
  assert.deepEqual(importers, ["lib/book-ready/families/matchup2.ts", "lib/book-ready/query.ts", "lib/persistence/supabase/matchup2-capture.ts", "lib/persistence/supabase/weekly-audit-store.ts", "lib/weekly-audit/build.ts", "lib/weekly-audit/gates.ts", "lib/weekly-audit/outcomes-matchup2.ts"]);
