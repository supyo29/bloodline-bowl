...
const defs: ChapterDef[] = [
  ...
  { id: "decision.roster_fit", title: "Roster fit", question: "What does this player do for the roster's needs and lineup?", tags: ["roster", "fantasy"], needs: [req("roster_health.team", { bind: "manager" })], viz: ["TABLE"] },
  { id: "decision.replacement_value", title: "Replacement value", question: "How much better is he than the freely available alternative?", tags: ["replacement", "fantasy", "waiver"], needs: [cap("replacement_level_evidence"), enr("waiver.status", { bind: "manager" })], viz: ["COMPARISON_BARS"] },
  ...
  { id: "waiver.availability_faab", title: "Availability & FAAB", question: "What does the league's waiver state allow, and at what FAAB position?", tags: ["faab", "waiver", "fantasy"], needs: [req("waiver.status", { bind: "manager" })], viz: ["TABLE"] },
  { id: "waiver.manager_competition", title: "Manager competition", question: "Which other managers need or will claim him?", tags: ["competition", "waiver", "managers"], needs: [cap("manager_competition_evidence")], viz: ["TABLE"] },
  { id: "waiver.drop_cost", title: "Drop cost", question: "Who would be dropped, and what does that cost?", tags: ["waiver", "roster", "drop"], needs: [capE("drop_cost_evidence"), req("roster_health.team", { bind: "manager" })], viz: ["TABLE"] },
  { id: "waiver.upside_uncertainty", title: "Upside & uncertainty", question: "What is the upside, and how uncertain is the role?", tags: ["uncertainty", "upside", "waiver"], needs: [req("role.player_profile"), req("fi.player_usage")], depends_on: ["player.role.trajectory"], viz: ["TABLE"] },
