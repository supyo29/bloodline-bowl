...
const defs: ChapterDef[] = [
  ...
  { id: "matchup.coverage_interaction", title: "Coverage interaction", question: "How does the opponent's coverage structure interact with his role?", tags: ["matchup", "coverage", "scheme", "slot_boundary"], needs: [req("scheme.defense_coverage", { bind: "opponent", comparisons: true }), req("matchup2.player.coverage", { positions: ["QB", "WR", "TE", "RB"] }), enr("matchup2.player.summary", { positions: ["QB", "WR", "TE", "RB"] })], viz: ["HEATMAP", "TABLE"],
    subchapters: [
  ...
  { id: "matchup.red_zone_defense", title: "Opposing red-zone defense", question: "How well does the opponent defend the red zone?", tags: ["touchdowns", "red_zone", "matchup", "scoring"], needs: [req("fi.team_metric", { bind: "opponent", params: { side: "defense", metrics: "def_rz_td_rate_allowed" }, comparisons: true }), enr("matchup2.player.scoring")], viz: ["PERCENTILE_BAR"] },
  ...
  { id: "decision.roster_fit", title: "Roster fit", question: "What does this player do for the roster's needs and lineup?", tags: ["roster", "fantasy"], needs: [req("roster_health.team", { bind: "manager" }), enr("waiver2.actions", { bind: "manager" }), enr("scoring.league_contract", { bind: "manager" })], viz: ["TABLE"] },
  { id: "decision.replacement_value", title: "Replacement value", question: "How much better is he than the freely available alternative?", tags: ["replacement", "fantasy", "waiver"], needs: [req("waiver2.replacement", { bind: "manager" }), enr("waiver2.actions", { bind: "manager" }), enr("waiver.status", { bind: "manager" }), enr("scoring.league_contract", { bind: "manager" })], viz: ["COMPARISON_BARS"] },
  { id: "decision.market_value", title: "Market / trade value", question: "What is his trade-market value?", tags: ["market", "trade", "fantasy"], needs: [req("trade.evaluation", { bind: "manager" }), enr("scoring.league_contract", { bind: "manager" })], viz: ["TABLE"] },
  ...
  { id: "game.pressure", title: "Pressure", question: "Where does pressure win or lose the game?", tags: ["pressure", "line", "game"], needs: [req("fi.team_metric", { bind: "both_teams", params: { side: "defense", metrics: "def_pressure_rate,def_blitz_rate" }, comparisons: true }), req("fi.team_metric", { bind: "both_teams", params: { side: "offense", metrics: "off_pressure_rate_allowed,off_sack_rate_allowed" }, comparisons: true }), enr("matchup2.defense.pressure", { bind: "own_team" })], viz: ["COMPARISON_BARS"] },
  ...
  { id: "defense.pressure", title: "Pressure", question: "How often does this defense pressure the passer?", tags: ["pressure", "defense"], needs: [req("fi.team_metric", { bind: "own_team", params: { side: "defense", metrics: "def_pressure_rate" }, history: true, comparisons: true }), enr("matchup2.defense.pressure", { bind: "own_team" })], viz: ["TIME_SERIES", "PERCENTILE_BAR"] },
  ...
  { id: "defense.coverage", title: "Coverage", question: "What coverage families does it play?", tags: ["coverage", "defense", "scheme"], needs: [req("scheme.defense_coverage", { bind: "own_team", comparisons: true }), enr("matchup2.defense.coverage", { bind: "own_team" })], viz: ["TABLE", "HEATMAP"] },
  { id: "defense.man_zone", title: "Man vs zone", question: "How does it split man and zone?", tags: ["coverage", "man_zone", "defense"], needs: [req("scheme.defense_coverage", { bind: "own_team" }), enr("matchup2.defense.coverage", { bind: "own_team" })], viz: ["TABLE"] },
  { id: "defense.shell", title: "Coverage shell", question: "Which shells does it show?", tags: ["coverage", "shell", "defense"], needs: [req("scheme.defense_coverage", { bind: "own_team" }), enr("matchup2.defense.coverage", { bind: "own_team" })], viz: ["TABLE"] },
  ...
  { id: "defense.run_fits", title: "Run fits", question: "How does it fit the run?", tags: ["run_defense", "defense"], needs: [req("matchup2.defense.front", { bind: "own_team" }), capE("run_fit_evidence"), enr("fi.team_metric", { bind: "own_team", params: { side: "defense", metrics: "def_rush_epa_allowed,def_explosive_rush_rate_allowed" }, comparisons: true })], viz: ["TABLE"] },
  ...
  { id: "waiver.availability_faab", title: "Availability & FAAB", question: "What does the league's waiver state allow, and at what FAAB position?", tags: ["faab", "waiver", "fantasy"], needs: [req("market.state", { bind: "manager" }), req("waiver2.market", { bind: "manager" }), enr("waiver.status", { bind: "manager" })], viz: ["TABLE"] },
  ...
  /* ---------------------------------------------------------------- TRADE */
  { id: "trade.player_value", title: "Player value", question: "What is the player worth in this league's trade market?", tags: ["market", "trade", "value"], needs: [req("trade.evaluation", { bind: "manager" }), enr("scoring.league_contract", { bind: "manager" })], viz: ["TABLE"] },
