...
const CLASS_MAP: Record<string, Record<string, AnalysisClass>> = {
  ...
  WAIVER2: { SHADOW_MODEL_OUTPUT: "SHADOW", CONDITIONAL_SCENARIO: "CONDITIONAL", CONSUMED_ROLE_EVIDENCE: "DESCRIPTIVE", DERIVED_FROM_STATE: "DESCRIPTIVE", DERIVED_FROM_PROJECTIONS: "PROJECTED" },
